...
public class HomeWorkString {
    public static void main(String[] args) {
        String str1 = "Это тестовая строка";
        ...
        String str3 = "ЭТО ТЕСТОВАЯ СТРОКА, НО ОНА другая";
